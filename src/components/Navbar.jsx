            ...
            <div className="nav-container">
                <div className="nav-wrapper">
                    ...
                    <div className="desktop-links" style={{ gap: '1rem' }}>
                        ...
                        <a href="/login" className="btn-primary" style={{ padding: '0.5rem 1.25rem', fontSize: '0.875rem' }}>
                            Get Started
                        </a>
                    </div>
            ...
            {isMobileMenuOpen && (
                <div className="mobile-menu glass">
                    ...
                    <div style={{ paddingTop: '1rem' }}>
                        ...
                        <a href="/login" className="btn-primary w-full" style={{ width: '100%', justifyContent: 'center' }}>
                            Get Started
                        </a>
                    </div>
                </div>
